 ...
 *  - Posiciones de memoria de los perifiericos disponibles en el micro descrito en la
 *    tabla 1 (Memory Map)
 *  - Incluir los demás drivers de los perifericos
 *  - definiciones de las constantes mas básicas.
 *
 *  Nota: La definicion del NVIC será realizada al momento de describir el uso de las
 *  interrupciones
 */
...
//#define NOP()    (___asm___ ("NOP"))
#define NOP()      asm("NOP")
#define __weak     __atribute__((weak))

/*
 *  Base addresses of Flash and SRAM memories
 *  Datasheet, Memory Map, Figure14
...
/*
 * NOTA: OPbservar que existen unos registros especificos del Cortex M4 en la región 0xE0000000U
...
/**
 *  AHBx and APBx Bus Peripherals base addreses
 */
...
/**
 *  Yahora debemos hacer lo mismo pero cada una de las posiciones de memoria de cada uno de los
 *  peifericos descritos en la Tabnla 1 del manual de referencia del micro.
...
#define FIR_BASE_ADDR           (AHB1_BASE_ADDR + 0x3C00U) //Flash Interface Registes...
...
//#define TIM11_BASE_ADDR       (APB2_BASE_ADDR + 0x4900U)
...
/* Defición de la estructura de datos que representa a cada uno de los registros que componen el
 * periférico RCC
 *
 ...
 * en la hoja de datos del equipo. Observe que los elementos "reservedx" tambien están presentes allí.
 * */
typedef struct
{
    ...
    volatile uint32_t reserved10;	// reserved									ADDR_OFFSET:    0x69
    ...
    volatile uint32_t DCKFGR; 		// Dedicated Clocks Configuration Reg		ADDR_OFFSET:    0x8C
} RCC_RegDef_t;

/*
 *  Hacemos como un "merge", en el cual ubicam,os la estructura RCC_RegDef a apuntar a la posicion de
...
/* +++======= INICIO de la descripción de los elementos que componen el perférico ===========+++ */
/* Defición de la estructura de datos que respresenta a cada uno de los registros que componen el
 * periférico GPIO.
 *
 * Debido a que el perifério GPIOx es muy simple, no es muy necesario crear la descripción bit a bit
...
/* Incluimos las librerios de cada periférico*/
