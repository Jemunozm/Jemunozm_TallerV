...
#ifndef INC_GPIO_DRIVER_HAL_H_
#define INC_GPIO_DRIVER_HAL_H_

#include <stdint.h>
#include "stm32f4xx.h"

/* Descripción de cada uno de losrequisitos del periférico (no es necesario para este) */
...
/* Valores estándar paralasconfiguraciones */
...
#define GPIO_PIN_MASK	0X0FU	/* Pin mask for assert tst */

/* Struture definition wich will keeps the configuration information for PinX	*/
typedef struct
{
...
#define IS_GPIO_PUPDR(PULL)		(((PULL) == GPIO_PUPDR_NOTING)		|| \
